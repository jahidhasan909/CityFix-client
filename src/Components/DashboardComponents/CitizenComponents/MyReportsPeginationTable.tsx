...
import { MoreVertical, Eye, Edit2, Trash2, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-40 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                <DropdownMenuItem className="cursor-pointer text-xs font-medium" >
                    <Link href={`/dashboard/citizen/reports/${request._id}`} className="flex items-center gap-2 w-full">
                ...
                {isResolved ? (
                    ...
                    <DropdownMenuItem className="cursor-pointer text-xs font-medium" >
                        <Link href={`/dashboard/citizen/reports/edit/${request._id}`} className="flex items-center gap-2 w-full">
                            <Edit2 className="h-3.5 w-3.5" />
