                                ...
                                <TableBody>
                                    {filteredUsers.map((user) => (
                                        <TableRow key={user._id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/40">
                                            ...
                                            <TableCell>
                                                <span className="px-2.5 py-0.5 rounded text-xs font-bold capitalize border bg-slate-100 border-slate-300 text-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700">
                                                    {user.role}
                                                </span>
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            <TableCell className="text-center">
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end" className="w-48 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl z-50">
                                                        ...
                                                        <DropdownMenuItem onClick={() => handleRoleUpdate(user._id, "officer")} className="cursor-pointer text-xs font-medium text-blue-600 focus:bg-blue-50 dark:focus:bg-blue-950/30">
                                                            Make Officer
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem onClick={() => handleRoleUpdate(user._id, "admin")} className="cursor-pointer text-xs font-medium text-red-600 focus:bg-red-50 dark:focus:bg-red-950/30">
                                                            Make Admin
                                                        </DropdownMenuItem>
                                                    </DropdownMenuContent>
                                                </DropdownMenu>
                                        ...
                                        <div className="relative">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end" className="w-48 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl z-50">
                                                    ...
                                                    <DropdownMenuItem onClick={() => handleRoleUpdate(user._id, "officer")} className="cursor-pointer text-xs font-medium text-blue-600">
                                                        Make Officer
                                                    </DropdownMenuItem>
                                                    <DropdownMenuItem onClick={() => handleRoleUpdate(user._id, "admin")} className="cursor-pointer text-xs font-medium text-red-600">
                                                        Make Admin
                                                    </DropdownMenuItem>
                                                </DropdownMenuContent>
                                            </DropdownMenu>
